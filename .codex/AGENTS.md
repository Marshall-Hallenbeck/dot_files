...
These principles apply to ALL projects. Project-specific AGENTS.md files override or extend these.
...
Fix issues from both tools, not just one. If a project's AGENTS.md specifies different commands (e.g., `uv run ruff`, `uv run pyright`), use those.
